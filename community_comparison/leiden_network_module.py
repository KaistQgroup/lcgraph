...
import copy
from leiden_helpers import leiden_communities_nx


class LeidenLayeredLawNetwork():
    ...
    def detect_communities(self):
        ...
        communities = leiden_communities_nx(self.graph, seed=self._seed, objective=self._type)
    ...
    def detect_subcommunities(self, levels=3):
        ...
        def recursive_community_detection(nodes, current_level, current_community, upper_community, max_level):
            ...
            communities = leiden_communities_nx(subgraph, seed=self._seed, objective=self._type)
